	    ...
	    @include('template.partials.alert')
	        <div class="row">
	            <div class="widget-content nopadding">
	                <form method="post" action="{{ route('gala.store')}}" enctype="multipart/form-data" class="form-horizontal"> 


					  <div class="form-group">
						<label class="col-sm-3 col-md-3 col-lg-2 control-label">Caption:</label>
