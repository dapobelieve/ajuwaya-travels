	    ...
	    @include('template.partials.alert')
	        <div class="row">
	            <div class="widget-content nopadding">
	                <form method="post" action="{{ route('posts.update', $post->id )}}" enctype="multipart/form-data" class="form-horizontal"> 
	                	{{method_field('PUT')}}

					  <div class="form-group">
						<label class="col-sm-3 col-md-3 col-lg-2 control-label">Post Title:</label>
						<div class="col-sm-9 col-md-9 col-lg-10">
							<input type="text" required name="postTitle" value="{{ Request::old('postTitle') ?: $post->title }}" id="postTitle" class="form-control input-sm" />
						</div>
					</div>
					  ...
					  <div class="form-group">
							...
							<div class="col-sm-9 col-md-9 col-lg-10">
	<textarea rows="5" placeholder="post content" name="postContent" required  id="postContent" class="form-control">{{ Request::old('postTitle') ?: $post->body}}</textarea>
							</div>
						</div>
